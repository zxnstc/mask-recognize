...
def Alignment_1(img, landmark):
    ...
    for i in range(landmark.shape[0]):
        pts = [RotationMatrix[0, 0] * landmark[i, 0] + RotationMatrix[0, 1] * landmark[i, 1] + RotationMatrix[0, 2],
...
def Alignment_2(img, std_landmark, landmark):
    ...
    new_landmark = []
    for i in range(landmark.shape[0]):
        pts = [Trans_Matrix[0, 0] * landmark[i, 0] + Trans_Matrix[0, 1] * landmark[i, 1] + Trans_Matrix[0, 2],
               Trans_Matrix[1, 0] * landmark[i, 0] + Trans_Matrix[1, 1] * landmark[i, 1] + Trans_Matrix[1, 2]]
        new_landmark.append(pts)
